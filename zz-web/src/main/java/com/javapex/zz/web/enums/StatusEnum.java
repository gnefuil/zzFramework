package com.javapex.zz.web.enums;
...
public enum StatusEnum {
    ...
    /** 404 */
    NOT_FOUND("404", "Need to declare a method by using @ZzRoute!"),

    /** IllegalArgumentException */
    ILLEGAL_PARAMETER("404", "IllegalArgumentException: You can only have two parameters at most by using @ZzRoute!"),
    ;
